...
const (
	TokenValidationService_ValidateToken_FullMethodName = "/iam.v1.TokenValidationService/ValidateToken"
)
...
//
// TokenValidationService lets trusted internal callers validate opaque Access Tokens online.
type TokenValidationServiceClient interface {
	// ValidateToken checks an Access Token against current User and Authentication Session state.
...
// All implementations should embed UnimplementedTokenValidationServiceServer
...
// UnimplementedTokenValidationServiceServer should be embedded to have
...
var TokenValidationService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "iam/v1/validate_token.proto",
}
